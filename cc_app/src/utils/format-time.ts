...
export const calculateElapsedTime = (startAt: string, endAt: string): string => {
  ...
  const formattedElapsed = `${elapsed.hours()} horas, ${elapsed.minutes()} minutos, ${elapsed.seconds()} segundos`;
