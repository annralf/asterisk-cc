...
import { ContextTableToolBar } from '../context/table-toolbar';
import {  ContextTableFiltersResult} from '../context/table-filters-results';
import { ContextTable } from '../context/table';
import ModalContextForm from '../context/modal';
import page from '@/src/app/(home)/page';
import { table } from 'console';
import { setContent } from '@tiptap/core/dist/commands';
...
export const AgentTable = () => {
    ...
    /* const handleEditRow = useCallback(
      (id: string) => {
        router.push(`${paths.context_setup.edit}/${id}`);
      },
      [router]
    ); */
